...
namespace Sample.UserManagement.Application
{
    public class CloudinaryImageUploadService : IImageUploadService
    {
        ...
        public async Task<string> UploadImageAsync(IFormFile imageFile)
        {
            ...
            if (imageFile.Length > 2_000_000) // Adjust the maximum file size limit as needed
            ...
            var uploadParams = new ImageUploadParams
            {
                ...
                Folder = "user-images" // Specify the folder where the images should be stored in Cloudinary
            };
        ...
        {
            // You can customize this method to validate the file extension or MIME type
